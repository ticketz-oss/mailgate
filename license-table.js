...
process.stdin.on('end', () => {
    ...
    console.log(
        '<!doctype html><html><head><meta charset="utf-8"><title>MailGate Licenses</title><meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css" integrity="sha384-zCbKRCUGaJDkqS1kPbPd7TveP5iyJE0EjAuZQTgFLD2ylzuqKfdKlfG/eSrtxUkn" crossorigin="anonymous"></head><body>'
    );
    console.log('<div class="container-fluid">');
    console.log(`<h1>MailGate v${packageData.version}</h1><p>MailGate includes code from the following software packages:</p>`);
